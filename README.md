...
<p>Once you downloaded the file you need to put the "gamex86.dll" file into "Kingpin/main".</p>
<p>After installing the patch old savegames will not work anymore, so you'll need to start a new game.</p>
